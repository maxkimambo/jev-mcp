...
const PROMPT_CONTEXT =
  ...
  "jev_ask with paths for questions about a few files, jev_extract for values from a file (all in one call), jev_rank_pages to pick which web search results to fetch, jev_screen before reading untrusted text. " +
